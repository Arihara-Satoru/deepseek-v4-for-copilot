...
const zh: Translations = {
	// Model descriptions
	'model.v2.5.detail': '原生多模态',
	'model.pro.detail': '旗舰推理',
	'model.v2.5.tooltip': '快速高效的 MiMo V2.5 模型，推理能力接近 V2.5 Pro，API 定价更经济。',
	'model.v2.5-pro.tooltip': 'MiMo V2.5 Pro 模型，面向 Agent 编程、广泛世界知识和高阶推理任务。',

	// API Key
	'auth.apiKeyRequiredDetail': '请先配置 API Key',
	'auth.prompt': '请输入 MiMo API Key 或兼容服务令牌。',
	...
	'thinking.enabled': '开启',
	'thinking.enabled.desc': '开启思考，适合需要推理与工具决策的任务',
	...
	'request.toolsLimitExceeded':
		'MiMo 单次 tools 请求建议最多支持 {0} 个 functions，当前请求包含 {1} 个。请先用 VS Code 的 Configure Tools 关闭不常用的工具；如果正在使用实验性稳定工具列表设置，请关闭它。',
	...
	'error.action.checkMimoStatus': 'MiMo 平台',
	...
	// Extension
	'extension.activateFailed': 'MiMo 扩展激活失败，请运行 "MiMo: 显示日志" 查看详情。',
	...
	'welcome.action.later': '稍后再说',
};

const en: Translations = {
	// Model descriptions
	'model.v2.5.detail': 'Native multimodal model',
	'model.pro.detail': 'Flagship reasoning model',
	'model.v2.5.tooltip':
		'Fast, efficient MiMo V2.5 model with reasoning close to V2.5 Pro and economical API pricing.',
	'model.v2.5-pro.tooltip':
		'MiMo V2.5 Pro model for agentic coding, broad world knowledge, and high-end reasoning.',
	...
	'thinking.enabled': 'On',
	'thinking.enabled.desc': 'Enable thinking for reasoning-heavy and agent tasks',
	...
	// Request
	'request.toolsLimitExceeded':
		'MiMo should receive at most {0} functions in a single `tools` request, but this request contains {1}. Use VS Code Configure Tools to disable tools you rarely use. If the experimental tool-list stabilization setting is enabled, turn it off.',
	'request.preflightRoundLimitExceeded':
	...
	'error.action.checkMimoStatus': 'MiMo Platform',
	...
	'welcome.message':
		'Welcome to MiMo for Copilot Chat. Set up your API key and basic settings to start using MiMo models in Copilot Chat.',
	'welcome.action.setApiKey': 'Set API Key',
	'welcome.action.openGuide': 'Open Guide',
	'welcome.action.openSettings': 'Open Settings',
	'welcome.action.later': 'Maybe Later',
};
