...
| `deepseek-copilot.visionModel`                    | _(自动)_                   | 用作图片代理的 VS Code 视觉模型。请通过 `DeepSeek: 配置视觉代理` 设置；新版保存为 `vendor/id`，旧版裸模型 ID 仍兼容读取                                                                                                                                                                                                                                    |
| `deepseek-copilot.visionPrompt`                   | _(内置)_                   | 用于描述图片附件的提示词                                                                                                                                                                                                                                                                                                                                   |
